...

{
  ...
  var component  = {
    ...
    config: {
      ...
      //File dependencies
      game_selection  : ['ccm.load', 'resources/pre_game.js'],
      game_master     : ['ccm.load', 'resources/game_master.js'],
      game_player     : ['ccm.load', 'resources/game_player.js'],
      db_pregame      : ['ccm.load', 'resources/database.js'], 
      db_game         : ['ccm.load', 'resources/database_game.js'],
      helper          : ['ccm.load', 'resources/helper.js'],
      ui              : ['ccm.load', 'resources/ui.js'],
      constants       : ['ccm.load', 'resources/constants.js'],
