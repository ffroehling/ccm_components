/**
 * @overview ccm component for quiz short_answer
    ...
    Instance: function () {
      ...
      this.show_correct_answer = () => {
        let html = {
          ...
          id : 'correct_answer',
          inner : [
            {tag : 'h3', inner : (this.template.your_answer || 'Your answer') + ': ' + this.given_answer
            },
            {tag : 'h3', inner : (this.template.correct_answer || 'Correct answer') + ': ' + this.correct
            },
            {tag : 'h3', inner : (this.template.correct || 'Correct') +
              ': ' + ((this.given_answer == this.correct) ? 
              (this.template.yes || "Yes") : (this.template.no || "No"))
            }
          ]
        }
      ...
      this.unify_config = async () => {
        ...
        return this.template && this.correct ; 
      }
